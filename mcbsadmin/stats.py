...
# Minimal process tree helper: find Bedrock server processes by cmdline marker.
BDS_MARKERS = ("bedrock_server",)


def find_server_pid(scan_cmdline: Optional[str] = None) -> Optional[int]:
    """Return the PID of a running Bedrock server, if any."""
    import os

    marker = scan_cmdline or "bedrock_server"
